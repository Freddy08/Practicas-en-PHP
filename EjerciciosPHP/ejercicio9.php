...
<html lang="es">
    ...
    <body>
        ...
        <br/>
        <br/>
        <h4>Que lea un importe bruto y calcule su importe neto, si es mayor de 1500 se le aplicará un 16% de impuestos, en caso contrario se le aplicará un 10%.</h4>
        <div>
            <form name="formulario" method="post" action="formulario_importe.php">
                
                <P style="font-size:20px">Cuanto es el importe: </P>  <input type="text" name="importe" value="">
                <br/>
                <br/>
